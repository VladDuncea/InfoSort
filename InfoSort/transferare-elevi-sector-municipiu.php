...
$sql="TRUNCATE TABLE Elevi_Municipiu";
$result = mysqli_query($conn,$sql);
$sql="INSERT INTO Elevi_Municipiu (Nume,Prenume,Clasa,Profesor,Scoala,Sector,ID_Elev,Adaugat_de)
SELECT Nume,Prenume,Clasa,Profesor,Scoala,Sector,ID_Elev,Adaugat_de FROM inscrieri
WHERE Adm_Resp='0'";

$result = mysqli_query($conn,$sql);
echo "Transfer reusit";
