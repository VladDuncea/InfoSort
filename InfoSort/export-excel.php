...
<article id="post-6" class="post-6 page type-page status-publish hentry">
	...
	<p>
<form method="post" action="http://florea.byethost18.com/excel.php" > 
 	 	<input type="submit" name="export_excel" value="Export to Excel" /> 
</form>
</p>
<p>
<form method="post" action="http://florea.byethost18.com/pdf.php" > 
 	 	<input type="submit" name="export_excel" value="Export to PDF" /> 
</form>
</p>
