...
<ul id="menu">
        ...
        echo"<li>Admin";
        echo"<ul>";
        echo"<li><a href='/creare-cont-2.php'>Creare cont pentru profesor</a></li>";
        echo"<li><a href='/administrare-conturi.php'><span>Administrare conturi</span></a></li>";
        echo"<li><a href='/transferare-elevi-sector-municipiu.php'><span>Transfer Sector->Municipiu</span></a></li>";
        echo"<li><a href='/upload-excel.php'><span>Upload Excel</span></a></li>";
        echo"<li><a href='/import-excel.php'><span>Import Excel</span></a></li>";
        echo"<li><a href='/export-excel.php'><span>Export Excel</span></a></li>";
    echo"</ul>";
echo"</li>";}?>
...
<article id="post-6" class="post-6 page type-page status-publish hentry">
	...
	<div class="entry-content"><!-- .CONTINUT-->
		<p></p><center>Bine ati venit !</center><p></p>
	</div><!-- .entry-content -->
