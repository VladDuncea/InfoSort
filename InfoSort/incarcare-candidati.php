...
if($_SESSION['userlevel']>1)
{
  ...
  $nr_ids=0;
  $variabile = array("ID_Elev","Nota1","Nota2","Premiul","Adm_Resp","Media",);
  $nr_ids=$_SESSION['numar_randuri'];
  
  for ($a=0;$a<$nr_ids;$a++)
  {
    $media=($_POST['Nota1'][$a]+$media=$_POST['Nota2'][$a])/2;
...
if($_POST['page']=="inscrieri"){                                                  /*VERIFICARE PAGINA PRECEDENTA*/
/*echo '<a href="/index.php/informatica-introducere-rezultate/">Inapoi</a>';*/
echo '<form method="post" action="/informatica-introducere-rezultate.php">
...
<input type='hidden' name='clasa_mem' value='{$_POST['clasa_mem']}'><input type='hidden' name='centru_mem' value='{$_POST['centru_mem']}'>";
echo '</form>' ;}                                                                                  /*MUNICIPIU*/
else{echo '<form method="post" action="informatica-introducere-rezultate-municipiu.php">            
<input type="submit" value="Inapoi">
<input type="hidden" value="da" name="search"/>';
echo"<input type='hidden' name='scoala_mem' value='{$_POST['scoala_mem']}'>
<input type='hidden' name='clasa_mem' value='{$_POST['clasa_mem']}'>";
echo '</form>' ;}
?>
